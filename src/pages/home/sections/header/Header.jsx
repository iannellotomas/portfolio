	...
	return (
		<header id="header" className={styles.header}>
			...
			<div className={styles.headerRight}>
				...
				<p>
					Soy un apasionado diseñador que transforma ideas creativas en
					experiencias digitales envolventes, con el objetivo de mejorar la
					usabilidad y crear interfaces impactantes. Estoy buscando progresar en
					mi carrera profesional, contribuyendo a equipos innovadores mientras
